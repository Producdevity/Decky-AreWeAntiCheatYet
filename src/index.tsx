import { ButtonItem, PanelSection, PanelSectionRow, Navigation, staticClasses, ToggleField } from '@decky/ui'
import {
  addEventListener,
  removeEventListener,
  callable,
...
export default definePlugin(() => {
  ...
  const listener = addEventListener<[test1: string, test2: boolean, test3: number]>(
    'timer_event',
    (test1, test2, test3) => {
