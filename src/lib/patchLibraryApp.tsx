import { afterPatch, findInReactTree, appDetailsClasses, createReactTreePatcher } from '@decky/ui'
    ...
    if (routeProps) {
      const patchHandler = createReactTreePatcher(
        ...
        (_: Array<Record<string, unknown>>, ret?: ReactElement) => {
          ...
          container.props.children.splice(1, 0, <StatusBadge status="Supported" />)
